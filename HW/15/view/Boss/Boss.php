<?php if ($findUser['status'] && $findDepartment) { ?>
...
<?php }else { ?>
    ...
    <p class="text-center text-[20px] font-[600] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">There is no department. First, create a department</p>
<?php } ?>