...
@section('main')
    <form action="{{ route('reserve.update', $reserve) }}" method="POST"
        class="flex flex-col gap-3 items-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px]">
        @method('PUT')
        @csrf
        ...
        <div class="flex justify-between flex-wrap mb-6 w-full gap-4" id="submit">
            <a href="{{ route('reserve.firstEdit', $reserve) }}"
